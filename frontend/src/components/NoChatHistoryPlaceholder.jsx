  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-6">
      <div className="w-16 h-16 bg-amber-500/20 rounded-full flex items-center justify-center mb-5">
        <MessageCircleIcon className="size-8 text-slate-50" />
      </div>
      ...
      <div className="flex flex-wrap gap-2 justify-center">
        <button className="px-4 py-2 text-xs font-medium text-slate-50 bg-amber-500/10 rounded-full hover:bg-amber-500/20 transition-colors">
          👋 Say Hello
        </button>
        <button className="px-4 py-2 text-xs font-medium text-slate-50 bg-amber-500/10 rounded-full hover:bg-amber-500/20 transition-colors">
          🤝 How are you?
